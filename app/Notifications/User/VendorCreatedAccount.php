...
class VendorCreatedAccount extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line(__("You have a maximum of ") . env('TIME_TO_VERIFY_ACCOUNT') . __(" minutes to verify your account. If the verification is not completed within this time, your information will be permanently deleted, and you’ll need to register again."))
