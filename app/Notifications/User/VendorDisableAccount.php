...
class VendorDisableAccount extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(__('For security purposes, your account will not be removed immediately. Instead, it is scheduled for permanent deletion in ') . env('DESTROY_CLIENTS_AFTER', 30) . __(' days.'))
