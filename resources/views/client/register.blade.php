...
@section('content')
    <div class="w-full flex min-h-screen login-form relative overflow-hidden">
        ...
        <div class="absolute inset-0 z-0 overflow-hidden">
            <div class="absolute top-[-10%] left-[-10%] w-[300px] h-[300px] bg-purple-300 opacity-30 rounded-full filter blur-3xl animate-pulse"></div>
            <div class="absolute bottom-[-10%] right-[-5%] w-[400px] h-[400px] bg-pink-300 opacity-20 rounded-full filter blur-2xl animate-spin-slow"></div>
            <div class="absolute top-1/2 left-[20%] w-[250px] h-[250px] bg-blue-200 opacity-40 rounded-full filter blur-2xl animate-float"></div>
            <div class="absolute top-2/2 left-[50%] w-[250px] h-[250px] bg-blue-200 opacity-40 rounded-full filter blur-2xl animate-float"></div>
        </div>

        <div class="hidden flex-col gap-8 lg:flex w-1/2 items-center justify-center p-16 animate-slide-in-right">
            <div class="relative w-60 h-60 flex items-center justify-center rounded-full bg-red bg-white shadow-2xl animate-float logo-astian">
            ...
            <div class="flex flex-col items-center gap-4">
                ...
                <span class="text-base text-center max-w-100">Access your account and enjoy a secure and personalized experience, with all the tools you need in one place.</span>
            </div>
        </div>

        <div class="w-full lg:w-1/2 flex justify-center p-8 lg:p-16 animate-slide-in-left">
            <div class="relative glass-card rounded-3xl p-8 lg:p-12 bg-white flex shadow-md flex-col justify-center w-full max-w-lg">
                        ...
                        <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            ...
                            <div class="relative mb-6">
                                <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A8.963 8.963 0 0112 15a8.963 8.963 0 016.879 2.804M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                            ...
                            <div class="relative">
                                <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3M3 11h18M5 19h14a2 2 0 002-2v-7H3v7a2 2 0 002 2z" />
                                </svg>
                            ...
                            <div class="relative">
                                <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m6-6v6a2 2 0 01-2 2H8a2 2 0 01-2-2v-6a2 2 0 012-2h1V9a3 3 0 016 0v2h1a2 2 0 012 2z" />
                                </svg>
